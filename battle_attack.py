...
def check_prio(pokemon:Pokemon, move_id:str, pokemon_ia:Pokemon,move_id_ia):
    move = getattr(pokemon, move_id)
    move_ia = getattr(pokemon_ia,move_id_ia)
    if move_ia.prio > move.prio or pokemon_ia.vit > pokemon.vit:
        return pokemon_ia,move_ia,pokemon,move
    return pokemon,move,pokemon_ia,move_ia
...
def perform_choice_attack(pokemon_1: Pokemon, pokemon_2: Pokemon, move_id: str,window,res_scene,resolution):
    ...
    pokemon_1,move_1,pokemon_2,move_2 = check_prio(pokemon_1,move_id,pokemon_2,move_id_ia)
    ...
    if not pokemon_2.is_dead():
        pokemon_2, pokemon_1 = pokemon_2.use_move(move_id,pokemon_1)
